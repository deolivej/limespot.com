window.addEvent('domready', function(){
	...
	// overrides 
	['layout_override', 'tools_for_pages', 'suffix_override', 'module_override', 'mootools_for_pages', 'sidebar_width_for_pages'].each(function(txt) {
	...
	//
	$$('.input-percents').each(function(el){
...
function getUpdates() {	
	...
	var update_url = 'https://www.gavick.com/updates/json/tmpl,component/query,product/product,gk_simplicity_j25';
...
function initConfigManager() {
     ...
     var deletebtn = document.id('config_manager_delete');
